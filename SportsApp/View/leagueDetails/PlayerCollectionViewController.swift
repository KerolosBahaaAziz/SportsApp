...
class PlayerCollectionViewController: UICollectionViewController ,UICollectionViewDelegateFlowLayout {

    var team : TeamDetails = TeamDetails()
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        print("passed players = \(team.players?.count)")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        {
           // print(team.players![indexPath.row].player_image!)
            let playerlogoUrl = URL(string: team.players![indexPath.row].player_image!)
            cell.playerImage.kf.setImage(with: playerlogoUrl)
